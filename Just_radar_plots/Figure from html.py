...
df1= pd.read_excel("17 Nov with R GPS data_cleaned - Duplicates removed.xlsx")
...
<div style="position: fixed; bottom: 50px; left: 50px; z-index: 1000; background-color: white; padding: 10px; border: 2px solid grey; font-size: 14px; font-family: 'CustomFont', sans-serif;">
    <b>Aanwezigheid van verkeersgeluiden</b><br>
...
for i in range(1,len(df1)):
    ...
    html = f'<img src="https://Ablenya.github.io/Radar_plots/{i}.png">'
...
m.save(f"Sound_of_{Source}.html")  
